...
public class RecyclerViewHolder$$ViewBinder<T extends example.com.recyclerviewdemo.Adapters.RecyclerViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492983, "field 'tv1'");
    target.tv1 = finder.castView(view, 2131492983, "field 'tv1'");
    view = finder.findRequiredView(source, 2131492984, "field 'tv2'");
    target.tv2 = finder.castView(view, 2131492984, "field 'tv2'");
