...
public class MainActivity$$ViewBinder<T extends example.com.recyclerviewdemo.Activities.MainActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131492972, "field 'myRecyclerView'");
    target.myRecyclerView = finder.castView(view, 2131492972, "field 'myRecyclerView'");
    view = finder.findRequiredView(source, 2131492969, "field 'mainCoordinatorLayout'");
    target.mainCoordinatorLayout = finder.castView(view, 2131492969, "field 'mainCoordinatorLayout'");
  }
